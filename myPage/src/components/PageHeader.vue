        ...
        <div class="header__burger burger">
            ...
            <nav class="burger__menu">
                <ul class="burger__list">
                    <li class="burger__item"><a href="#about-me" class="burger__link">About me</a></li>
                    <li class="burger__item"><a href="#portfolio" class="burger__link">Portfolio</a></li>
                    <li class="burger__item"><a href="#contacts" class="burger__link">Contacts</a></li>
                </ul>
            </nav>
        </div>
    </header>
